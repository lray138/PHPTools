...
class StringTool {
	...
	static function kebalbToCamelCase($string) {
		return lcfirst(self::kebalbToPascalCase($string));
	}

	static function kebalbToPascalCase($string) {
		return str_replace("-", "", ucwords($string, "-"));
	}

    /* everything below is from Pro PHP MVC */
